...
### Concluding thoughts
That's all of the lenses. Through most of them, it is not ethical to use AI for my personal projects, and I have been myopic about the data center proliferation being the significant bad thing about AI usage. Will I continue to use AI tools despite this analysis? Maybe? Probably? It is currently a culturally accepted norm to use these tools, which is a powerful thing. As an optimist, I also want to be hopeful about the benefit of my usage outweighing the bad of my individual usage. 